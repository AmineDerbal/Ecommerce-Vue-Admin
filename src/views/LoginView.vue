    ...
    <v-col cols="12" md="8" sm="6" class="h-100">
      <v-avatar :style="{ backgroundColor: 'red' }" >
        ...
        <v-form @submit.prevent>
          <v-text-field v-model="user" label="username" type="text" prepend-icon="$account" placeholder="admin" required></v-text-field>
          <v-text-field v-model="password" label="Password" type="password" prepend-icon="$lock" placeholder="admin" required></v-text-field>
